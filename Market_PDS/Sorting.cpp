...
vector<product> Sorting::toSort(vector<product>products, string way, string catg) {
	if (way == "name") {
		...
		//push products of selected category
...
//choose product then show it
void Sorting::setGetProduct(vector<product> p) {
	cout << "Choose Product:\n";
	int NoProduct;//number of product
	cin >> NoProduct;
	vector<product>::iterator it = p.begin();
...
//print the categories and choose one of them then return it
string Sorting::setGetCategory(vector<product> p) {
	...
	int NoCategory;//number of category
	while (true)
	{
		
		cout << "Choose Category:\n";
		//print categories and choose one
