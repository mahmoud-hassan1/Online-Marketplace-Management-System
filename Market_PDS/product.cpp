...
string product::getCategory() { return catg; }
int product::getQuantity() { return quan_product; }
float product::getRate() {
	cout << setprecision(2);
	return rate;
}
int product::getQuantityOfuser() { return quan_user; }
int product::getSellerId() { return selId; }
int product::getratnum() { return ratcount; }